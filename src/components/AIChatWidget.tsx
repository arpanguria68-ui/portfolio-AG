...
const AIChatWidget = () => {
    ...
    return (
        <>
            ...
            {/* Chat Panel */}
            <div
                className={`fixed bottom-24 right-6 w-[380px] max-w-[calc(100vw-48px)] h-[500px] max-h-[calc(100vh-150px)] bg-[#0a0a0a] border border-white/10 rounded-3xl shadow-2xl z-50 flex flex-col overflow-hidden transition-all duration-300 ${isOpen
